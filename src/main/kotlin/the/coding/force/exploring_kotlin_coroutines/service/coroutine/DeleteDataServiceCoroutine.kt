...
class DeleteDataServiceCoroutine(
     ...
     * if the data exists it will be deleted in database, case the data does not exist an exception
     * `DataNotFoundException` will be thrown. The logger will register the status of delete operation
     *
     * @author Lucas Terra
     * @param dataId ID from `DataEntity` received from suspend controller `delete` to find in database
     * @return `Unit`
